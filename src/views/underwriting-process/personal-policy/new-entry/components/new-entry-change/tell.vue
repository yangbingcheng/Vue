...
export default {
  ...
  methods: {
    ...
    selectChange() { },
    messageEntry() {
      this.$router.push('/underwriting-process/personal-policy/message-entry')
    },
    noteQuery() {
      this.$router.push('/underwriting-process/personal-policy/note-query')
    },
    problemQuery() {
      this.$router.push('/underwriting-process/personal-policy/problem-query')
    },
    problemEntry() {
      this.$router.push('/underwriting-process/personal-policy/problem-entry')
    },
    photoQuery() {
      this.$router.push('/underwriting-process/personal-policy/photo-query')
    },
    otherButton() { },
