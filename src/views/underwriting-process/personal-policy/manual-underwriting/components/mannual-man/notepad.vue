<template>
    <div class="main">
           <el-main>
                <p><span @click="isShow">{{ shape }}</span>待发送问题件信息</p>
                <el-table
                    :data="datas"
                    style="width: 100%"
                ...
                <div class="block" style="margin:20px 0;">
                  ...
                  <el-button type="primary" @click="submitForm('formData')" style="margin:0 10px;">首页</el-button>
           <el-button type="primary" @click="submitForm('formData')" style="margin:0 10px;">上一页</el-button>
            <el-button type="primary" @click="submitForm('formData')" style="margin:0 10px;">下一页</el-button>
             <el-button type="primary" @click="submitForm('formData')" style="margin:0 10px;">尾页</el-button>
          </el-main>
         <el-main>
            ...
            <el-form :model="formData" :rules="rules" ref="formData" label-width="120px" class="demo-ruleForm" label-position="right" v-if="formFlag">
              <el-row type="flex" class="row-bg">
                  <el-col :span="8">
                      <el-form-item label="发送对象" prop="policyNumber" size="small" :required="false">
                          <el-input v-model="formData.policyNumber" style=""></el-input>
                      </el-form-item>
                  </el-col>
                  <el-col :span="8">
                      <el-form-item label="是否下发" prop="management" size="small" :required="false">
                          <el-input v-model="formData.management" style=""></el-input>
                      </el-form-item>
                  </el-col>
                  <el-col :span="8">
                      <el-form-item label="是否计入初审" prop="distributionChannel" size="small" :required="false">
                 ...
                 <el-row type="flex" class="row-bg">
                  <el-col :span="8">
                      <el-form-item label="问题件选择" prop="policyNumber" size="small" :required="false">
                          <el-input v-model="formData.policyNumber" style=""></el-input>
                      </el-form-item>
                  </el-col>
                  <el-col :span="8">
