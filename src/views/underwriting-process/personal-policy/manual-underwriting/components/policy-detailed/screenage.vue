<template>
  <div class="main">
    ...
    <el-main>
      <p><span @click="isShowOther">{{ shapeOther }}</span>其他业务员信息<el-button type="primary" @click="otherButton" style="margin:5px;">其他业务员信息随动</el-button></p>
      <el-table
        :data="dataOther"
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-input v-model="scope.row.coding" style="" size="mini"></el-input>
          </template>
        </el-table-column>
        <el-table-column
