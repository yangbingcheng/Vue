<template>
  <div class="main">
    <el-main>
      <p><span @click="isShowTell">{{ shapeTell }}</span>投保人告知信息<el-button type="primary" @click="otherButton" style="margin:5px;">健康告知随动</el-button><el-button type="primary" @click="otherButton" style="margin:5px;">财务告知随动</el-button><el-button type="primary" @click="otherButton" style="margin:5px;">告知说明随动</el-button></p>
      <div class="table" v-if="flagTell">
        ...
        <div>
          <el-table :data="customerList" border>
            <el-table-column label="序号" type="index" min-width="6%" align="center"></el-table-column>
            <el-table-column prop="customerNumber" label="客户号码" min-width="15%" align="center"></el-table-column>
            <el-table-column prop="customerName" label="姓名" min-width="15%" align="center"></el-table-column>
            <el-table-column prop="gender" label="性别" min-width="13%" align="center"></el-table-column>
            <el-table-column prop="birthday" label="出生日期" min-width="15%" align="center">
            </el-table-column>
            <el-table-column prop="relationship" label="与第一被保险人关系" min-width="20%" align="center"></el-table-column>
            <el-table-column prop="internalNumber" label="客户内部号" min-width="12%"  align="center"></el-table-column>
          </el-table>
        </div>
      </div>
    </el-main>
    <el-main>
      <p><span @click="isShowCompact">{{ shapeCompact }}</span>被保险人资料客户号：<el-input v-model="formData.name" style="width:150px"></el-input><el-button type="primary" @click="otherButton" style="margin:5px;">查询</el-button>首次投保客户无需填写客户号)</p>
...
export default {
  ...
  data() {
    return {
      ...
      customerList: [
        {
          customerNumber: '000002344',
          customerName: '马晓东',
          gender: '女',
          birthday: '1998-02-01',
          relationship: '本人',
          internalNumber: '第1被保险人'
        }
      ],
      functionDatas: [
        {
