      ...
      <el-main>
        <el-form :model="formData" :rules="rules" ref="formData" label-width="150px" class="demo-ruleForm" label-position="right">
          <el-row type="flex" class="row-bg">
            <el-col :span="8">
              <el-form-item label="业务号码" prop="businessNumber" size="small" :required="false">
                <el-input v-model="formData.businessNumber"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
        ...
        <el-table :data="videoInformationList" border v-show="flag" >
          ...
          <el-table-column prop="documentNumber" label="单证号" width="150" align="center"></el-table-column>
          <el-table-column prop="category" label="影像类别" width="100" align="center"></el-table-column>
          <el-table-column prop="videoName" label="影像名称" width="180" align="center"></el-table-column>
          <el-table-column prop="batchNumber" label="扫描批次号" width="150" align="center"></el-table-column>
          <el-table-column prop="page" label="页数" width="50" align="center"></el-table-column>
          <el-table-column prop="scanDate" label="扫描日期" width="120" align="center"></el-table-column>
          <el-table-column prop="scanTime" label="扫描时间" width="100" align="center"></el-table-column>
          <el-table-column prop="employeeNumber" label="扫描员工号" width="100" align="center"></el-table-column>
          <el-table-column prop="partsNumber" label="件号" width="50"></el-table-column>
        </el-table>
